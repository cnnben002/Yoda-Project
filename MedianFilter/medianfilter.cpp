...
void createKnownSquareMatrix(int Size, string* squareMatrix, bool displayMatrices)
{
	for(int i = 0; i<Size; i++){
		for(int j = 0; j<Size; j++){
			squareMatrix[i*Size+j] = to_string(i*Size+j*Size) + " " + to_string(i*Size+j*Size + 1) + " " + to_string(i*Size+j*Size + 2);
			if(displayMatrices){
